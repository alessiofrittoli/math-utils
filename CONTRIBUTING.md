# Contributing to Math Utils 🤓

We’re excited that you’re interested in contributing to Math Utils! This guide will help you get started.
...
- Search Existing Issues: Check the [Issues](https://github.com/alessiofrittoli/math-utils/issues) tab to see if your concern has already been addressed.
...
- Go to the [repository page](https://github.com/alessiofrittoli/math-utils).
- Click the Fork button.
- Clone your fork to your local machine:

```bash
git clone https://github.com/your-username/math-utils.git
```
...
Thank you for helping improve Math Utils! 🎉